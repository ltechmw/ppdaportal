...
// if save button on the form is clicked
    ...
    if (!in_array($extension, ['pdf', 'docx', 'doc'])) {
        ...
        if (move_uploaded_file($file, $destination)) {
			...
			$sql = "INSERT INTO advup (advtitle, advclosedate, advfile, advdept, advreference, size,downloads,status)
VALUES ('$advtitle', '$advclosedate', '$filename', '$advdepartment','$advreference', '$size',0,1)";
