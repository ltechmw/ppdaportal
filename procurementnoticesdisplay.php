...
if ($result->num_rows > 0) {
    ...
    while($row = $result->fetch_assoc()) {
		...
		<td><?php echo $row["advdept"]; ?></td>
			<td><?php echo $row["advreference"]; ?></td>
		<td><?php echo $row["advclosedate"]; ?></td>
		
	
		<td><?php echo $row["size"]; ?></td>
		<td><?php echo $row["downloads"]; ?></td>
		<td><a href="advertupedit.php?id=<?php echo $row["advID"]; ?>"><button class="btn btn-primary btn-sm">Edit</button></a></td>
		<td><a href="advertuarchive.php?aid=<?php echo $row["advID"]; ?>"><button class="btn btn-danger btn-sm">Archive</button></a></td>
